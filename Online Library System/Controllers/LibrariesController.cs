...
namespace Online_Library_System.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Location,openHour,closeHour")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Location,openHour,closeHour")] Library library)
        {
            if (ModelState.IsValid)
            {
